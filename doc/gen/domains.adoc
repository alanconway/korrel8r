...
Query uses the same format as a link:https://pkg.go.dev/github.com/korrel8r/korrel8r/pkg/domains/k8s#Query[k8s.Query] with and additional 'container' field.
